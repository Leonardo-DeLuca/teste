...
Ext.define('Ext.theme.graphite.dom.Element', {override:'Ext.dom.Element'}, function() {
  Ext.onDocumentReady(function() {
    Ext.getBody().addCls([Ext.baseCSSPrefix + 'dark-mode', Ext.baseCSSPrefix + 'theme-graphite']);
  });
});
...
Ext.define('Ext.theme.graphite.Component', {override:'Ext.Component'}, function() {
...
Ext.define('Ext.theme.graphite.button.Split', {override:'Ext.button.Split', separateArrowStyling:true});
...
Ext.define('Ext.theme.graphite.form.Labelable', {override:'Ext.form.Labelable', labelWidth:140});
...
Ext.define('Ext.theme.graphite.form.field.File', {override:'Ext.form.field.File', _pressedCls:'x-form-field-file-buttononly', beforeRender:function() {
  this.callParent();
  if (this.buttonOnly) {
...
Ext.define('Ext.theme.graphite.grid.RowEditor', {override:'Ext.grid.RowEditor', height:56});
...
Ext.define('Ext.theme.graphite.grid.column.Action', {override:'Ext.grid.column.Action', align:'center'});
...
Ext.define('Ext.theme.graphite.menu.Menu', {override:'Ext.menu.Menu', minWidth:230});
...
Ext.define('Ext.theme.graphite.pivot.plugin.configurator.Panel', {override:'Ext.pivot.plugin.configurator.Panel', defaultMinWidth:300, headerWidth:140});
